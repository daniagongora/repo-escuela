...
;(oR (list (bool false) (bool false)))
;(anD (list (bool false) (bool false)))
(define (anD lst)
  (bool (andmap(lambda(x) (equal? x (bool #t))) lst  )))
  ;(cond
    ;[(null? lst) (bool true)] 
    ;[(and (car lst) (anD (cdr lst))) (bool true)] 
    ;[else (bool false)])) 


(define (oR lst)
   (bool (ormap(lambda(x) (equal? x (bool #t))) lst  )))
  ;(cond
    ;[(null? lst) (bool false)]
    ;[(car lst) (bool true)]
    ;[else (oR (cdr lst))]))
...
(define (parse sexp)
  (cond
    ;[oR(eq? true sexp) (bool true)] ;;caso especial ejercicio 2
    ;[oR(eq? false sexp) (bool false)];;caso especial ejercicio 2
    ;[anD(eq? true sexp) (bool true)] ;;caso especial ejercicio 2
    ;[anD(eq? false sexp) (bool false)];
